...
const page = () => {
  ...
  return (
    <div className='max-container flexOne flex-col padding-container2 gap-x-10 pt-10 pb-[10px] md:gap-x-10 lg:pt-10'>
      ...
      <div className='w-[445px] lg:w-[570px] xxl:w-[660px] -mt-0 3xl:w-[820px] flex justify-center items-center dropShadow rounded-[8px] h-[669px] my-auto  text-center font-bold text-[43px]'>
