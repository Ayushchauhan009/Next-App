...
const page = () => {
  ...
  return (
    <div className='max-container flexOne padding-container2 gap-10 pt-10 pb-[33px] md:gap-4 lg:pt-10'>
        ...
        <div className='w-[530px] xxl:w-[630px] rounded-[8px] flex flex-col '>
      ...
      {audioData ? (<OutputNoise audio={audioData}/>) : ( 
        <div className='w-[530px] xxl:w-[630px]  font-bold text-[43px] dropShadow rounded-[8px] h-[735px]  '>Output</div>
      )}
      </div>
        <VolEffects />
    </div>
